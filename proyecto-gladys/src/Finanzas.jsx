...
const CATEGORIAS_EGRESO = [
  { categoria: "Nómina",       monto: 35800, color: "#e8003a",  descripcion: "Pago de personal y prestaciones" },
  { categoria: "Insumos",      monto: 28000, color: "#ff6b35",  descripcion: "Materias primas y productos" },
  { categoria: "Renta",        monto: 15000, color: "#ffaa00",  descripcion: "Arrendamiento del local" },
  { categoria: "Equipamiento", monto: 4500,  color: "#00cc66",  descripcion: "Utensilios y mobiliario" },
  { categoria: "Marketing",    monto: 1500,  color: "#4488ff",  descripcion: "Publicidad y redes sociales" },
];
  ...
  return (
    <div className="fin-page">
      ...
      <div className="fin-card">
            ...
            return (
              <div key={i} className="fin-barra-row fin-barra-row-full">
                ...
                <div className="fin-barra-nums">
                  ...
                  <span className="fin-barra-pct">{pct}%</span>
                </div>
              </div>
            );
          })}
        ...
        {/* Mini resumen al pie */}
        <div className="fin-desglose-resumen">
          {CATEGORIAS_EGRESO.map((cat, i) => (
            <div key={i} className="fin-resumen-item">
              <span className="fin-resumen-dot" style={{ background: cat.color }} />
              <span className="fin-resumen-cat">{cat.categoria}</span>
              <span className="fin-resumen-pct">
                {((cat.monto / totalEgresos) * 100).toFixed(0)}%
              </span>
            </div>
          ))}
        </div>
        ...
        <div className="fin-modal-overlay" onClick={() => setModalAbierto(false)}>
          <div className="fin-modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="fin-modal-campos">
              ...
              <input className="fin-input" placeholder="Fecha (ej: 21 Abr 2026)" value={nueva.fecha} onChange={e => setNueva({...nueva, fecha: e.target.value})} />
            </div>
